...
export class RacunComponent implements OnInit, OnDestroy, OnChanges {
  ...
  openDialog(flag: number, id?: number, naziv?: string, oznaka?: string, opis?: string, klijent?: Klijent, tipRacuna?: TipRacuna) {
    const dialogRef = this.dialog.open(RacunDialogComponent, { data: { id, naziv, oznaka, opis, klijent, tipRacuna } });
